...
import { BookOpen, CalendarDays, Gamepad2, Heart, MapPin } from "lucide-react";
...
export function HomeQuickLinks() {
  ...
  return (
    <div className="-mt-10 grid gap-3 rounded-card border border-gold/20 bg-cream-soft p-4 shadow-card sm:grid-cols-2 lg:grid-cols-5">
      {links.map((link) => {
