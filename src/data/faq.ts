    ...
    items: [
      {
        ...
        answer:
          "Formal / Evening attire. But if you wear pajamas, be prepared to dance in pajamas! Weather permitting, the ceremony is outside, so some heels and stilettos may be hard to walk in.",
      },
    ],
  },
  {
