...
export const schedule: ScheduleEvent[] = [
  {
    ...
    description: "The event begins. Come in, find a smile, and settle into the day.",
  ...
  },
  {
    ...
    description: "The main course, a little catching of breath, and a table full of people you love.",
